...
class AppColors {
  ...
  static const Color secondaryDarkColor =  Color.fromRGBO(66, 66, 66,1);
  static const Color primaryDarkColor =  Color.fromRGBO(33, 33, 33,1);
  ...
  static const Color deleteColor =  Color(0xffff0222);
  ...
  static const MaterialColor primaryMaterialColor = MaterialColor(
    ...
    <int, Color>{
      50: Color(0xFFEEEFF5),
      100: Color(0xFFEEEFF5),
      200: Color(0xFFEEEFF5),
      300: Color(0xFFEEEFF5),
      400: Color(0xFFEEEFF5),
      500: Color(0xFFEEEFF5),
      600: Color(0xFFEEEFF5),
      700: Color(0xFFEEEFF5),
      800: Color(0xFFEEEFF5),
      900: Color(0xFFEEEFF5),
    },
  );
